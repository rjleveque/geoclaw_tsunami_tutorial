...
:::{seealso}
See [](README) for summary of the scripts and notebooks in this directory,
and links to pages showing **sample fgout and fgmax results** for the GeoClaw
example that is set up in this directory.
:::

Scroll down for discussions of the new things that must be added to
`setrun.py` to specify these grids:
- [](example2-setrun)
- [](fgout-setrun)
- [](fgmax-setrun)
