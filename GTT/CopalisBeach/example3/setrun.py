...
#------------------------------
    ...
    one_ninth_sec = 1 / (9*3600)

    clawdata.lower[0] = -128.5 - one_ninth_sec     # west longitude
    clawdata.upper[0] = -123.5 - one_ninth_sec     # east longitude

    clawdata.lower[1] = 45. - one_ninth_sec        # south latitude
    clawdata.upper[1] = 49. - one_ninth_sec        # north latitude
    ...
    # centered in 1/3" cells based on domain edges using center_gauges.py:
    gauges.append([101, -124.1899846, 47.1160340, 0, 1e+09]) # slightly offshore
    gauges.append([102, -124.1799846, 47.1160340, 0, 1e+09]) # onshore
    gauges.append([103, -124.1706327, 47.1160340, 0, 1e+09]) # in river
    ...
    fgmax.point_style = 4            # specified by file fgmax.xy_fname
    fgmax.xy_fname = 'fgmax_pts_CopalisBeach.data'
